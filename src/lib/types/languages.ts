...
export const LANGUAGE_NAME_MAP: Record<LanguageCode, LanguageName> = languages.reduce(
  (acc, lang) => {
...
export const LANGUAGE_CODE_MAP: Record<LanguageName, LanguageCode> = languages.reduce(
  (acc, lang) => {
