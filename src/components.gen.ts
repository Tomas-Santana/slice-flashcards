...
export type ComponentName = 'Button' | 'Card' | 'Checkbox' | 'CodeVisualizer' | 'Details' | 'DropDown' | 'Grid' | 'Icon' | 'Input' | 'Layout' | 'Loading' | 'Logo' | 'MultiRoute' | 'Navbar' | 'NotFound' | 'Route' | 'Select' | 'Sidebar' | 'SidebarLink' | 'SidebarToggle' | 'Switch' | 'TreeItem' | 'TreeView' | 'EventManager' | 'FetchManager' | 'Link' | 'LocalStorageManager' | 'Translator' | 'HomePage' | 'Playground' | 'StartPage';
