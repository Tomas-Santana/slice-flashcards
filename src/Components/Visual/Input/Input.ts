import { InputProps, InputConditions } from "./Input.types";

export default class Input extends HTMLElement {
  private _conditions: InputConditions | null = null;
  ...
  private $eyeIcon: HTMLElement | null = null;
  ...
  init() {
    ...
    if (this.conditions) {
      this.$input.setAttribute("maxlength", String(this.conditions.maxLength || ""));
      this.$input.setAttribute("minlength", String(this.conditions.minLength || ""));
  ...
  validateValue() {
    if (this._regex && !this._regex.test(this.$input.value)) {
      this.triggerError();
      return false;
    }
    this.triggerSuccess();
